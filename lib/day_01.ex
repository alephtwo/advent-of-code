defmodule Day01 do
  ...
  sonar sweep report (your puzzle input) appears: each line is a measurement of
  the sea floor depth as the sweep looks further and further away from the
  submarine.
  ...
  @spec parse_input(String.t()) :: list(integer())
