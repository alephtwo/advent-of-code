defmodule Day01 do
  ...
  @doc """
  Calculate the result for Day 1, Part 1 as prompted:
  ...
  @doc """
  Calculate fuel requirements for the given mass.
  """
  @spec calculate_fuel_from_mass(number) :: number
  def calculate_fuel_from_mass(mass), do: div(mass, 3) - 2

  @doc """
  Calculate the result for Day 2, Part 2 as prompted:
  ...
  @doc """
  Calculate fuel requirements for the given mass, accounting for the mass of
  additional fuel recursively.
  """
  @spec calculate_fuel_recursively(number) :: number
