defmodule Day05 do
  ...
  @type line_t :: %{start: point_t(), end: point_t()}
  ...
  * An entry like `9,7 -> 7,9` covers points `9,7`, `8,8`, and `7,9`.
  ...
  @spec parse_input(String.t()) :: list(line_t())
